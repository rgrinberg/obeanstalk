...
module Command : sig
  type t = { name : string; args : string list; } with sexp
...
module Request : sig
  type t = Single of Command.t | WithJob of Command.t * string
...
module Response : sig
  ...
  val try_with : ('a -> 'b) -> resp:'a -> 'b Core.Std.Or_error.t
  val try_with_ignore : ('a -> 'b) -> resp:'a -> unit Core.Std.Or_error.t
end
